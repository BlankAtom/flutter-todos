        ...
        child: ListView(
          children: <Widget>[
            ...
            RadioListTile(
              ...
              groupValue: globalModel.currentNavHeader,
              subtitle: CustomCacheImage(
                url: NavHeadType.DAILY_PIC_URL,
                        ...
                        onTap: () {
                          Navigator.of(context)
                            ...
                            return ProviderConfig.getInstance()
                                .getNetPicturesPage(
                                    useType:
                                        NetPicturesUseType.navigatorHeader);
                          }));
                        },
                        child: CustomCacheImage(
                          url: globalModel.currentNetPicUrl,
                          key: GlobalKey(),
                        ),
                      )),
          ],
    ...
    if (value == NavHeadType.dailyPic) {
      ...
      if (time == null)
        SharedUtil.instance.saveString(
            Keys.everyDayPicRefreshTime, DateTime.now().toIso8601String());
    }
