  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          IntlLocalizations.of(context).doneList,
          style: TextStyle(
            color: bgColor,
          ),
        ),
      ...
      body: Container(
        ...
        child: model.doneTasks.isNotEmpty
                          ...
                          child: FadeInAnimation(
                            child: Row(
                              ...
                              children: <Widget>[
                                InkWell(
                                  onTap: () =>
                                      model.logic.onTaskTap(index, task),
                                  child: Container(
                                    height: itemHeight,
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: <Widget>[
                                            ...
                                            Text(
                                              "${IntlLocalizations.of(context).taskNum}:${task.taskDetailNum}",
                                              style: TextStyle(
                                                fontSize: textSize,
                                                color: textColor,
                                              ),
                                            ...
                                            Text(
                                              "${IntlLocalizations.of(context).createDate}:${model.logic.getTimeText(task.createDate)}",
                                              style: TextStyle(
                                                fontSize: textSize,
                                                color: textColor,
                                              ),
                                        ...
                                        child: Column(
                                          ...
                                          children: <Widget>[
                                            Container(
                                              width: itemHeight,
                                              child: Text(
                                                "${IntlLocalizations.of(context).spendTime}:${model.logic.getDiffTimeText(task.createDate, task.finishDate)}",
                                                maxLines: 3,
                                                style: TextStyle(
                                                  fontSize: textSize,
                                                  color: textColor,
                                            ...
                                            Text(
                                              "${IntlLocalizations.of(context).changedTimes}:${task.changeTimes}",
                                              style: TextStyle(
                                                fontSize: textSize,
                                                color: textColor,
                                              ),
                                            ...
                                            Text(
                                              "${IntlLocalizations.of(context).completeDate}:${model.logic.getTimeText(task.finishDate)}",
                                              style: TextStyle(
                                                fontSize: textSize,
                                                color: textColor,
                                              ),
            ...
            : LoadingWidget(
                ...
                errorCallBack: () {},
                emptyText: IntlLocalizations.of(context).toFinishTask,
              ),
      ),
    );
  }
