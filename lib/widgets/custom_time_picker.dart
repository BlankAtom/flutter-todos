...
class CustomTimePicker extends StatefulWidget {
  ...
  const CustomTimePicker({required Key key, required this.callBack})
      : super(key: key);
              ...
              Expanded(
                child: Row(
                  ...
                  children: <Widget>[
                    Container(
                      child: Text(
                        IntlLocalizations.of(context).start,
                    ...
                    Container(
                      child: Text(
                        IntlLocalizations.of(context).end,
                        style: TextStyle(fontSize: 12),
                      ),
                      margin: EdgeInsets.only(bottom: 18),
                    ),
                            ...
                            if (start >= end) {
                              showDialog(
                                ...
                                builder: (ctx) => AlertDialog(
                                  ...
                                  content: Text(
                                      IntlLocalizations.of(context).timeError),
                                ),
                              );
                              return;
                            }
